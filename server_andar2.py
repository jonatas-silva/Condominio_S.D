...
# SERVIDOR DO PREDIO
context = zmq.Context()
# p = "tcp://"+ HOST +":"+ PORT6 # how and where to connect
p = "tcp://"+ ANDAR2_PRIVADO +":"+ PORT3 # how and where to connect
...
identificador_andar = {1 : "andar 2", 2 : "Andar 2", 3 : "andar2"} # identificadores do andar
